...
{
    /// <summary>
    /// Métodos que debe tener una capa de negocio
    /// </summary>
    /// <typeparam name="T">Entidad que administra la capa de negocio</typeparam>
    public interface IBussinesUser
    {
        /// <summary>
        /// Consulta un usuario dado su email y contraseña
        /// </summary>
        /// <param name="entity">Usuario a consultar</param>
        /// <param name="password">Contraseña del usuario encriptada</param>
        ...
        User ReadByEmailAndPassword(User entity, string password, string key, string iv);
        ...
        /// <param name="password">Nueva contraseña del usuario encriptada</param>
        /// <param name="key">Llave para el algoritmo AES</param>
        /// <param name="iv">Vector de inicializaci{on para el algoritmo AES</param>
        /// <param name="user">Usuario que realiza la actualización de la contraseña</param>
        ...
        /// <param name="user1">Usuario que asigna el rol al usuario</param>
        ...
        /// <param name="user1">Usuario que elimina el rol del usuario</param>
